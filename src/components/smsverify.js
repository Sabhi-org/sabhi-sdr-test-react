                    ...
                    <Row>
                        <Col span={4} offset={2}>
                            <div className="smscodecontainer">
                                <input className="inputsinsms" maxlength="1" type="text" name="ssn-1" onChange={handleChange} />
                            </div>
                        </Col >
                        <Col span={4} offset={1}>
                            <div className="smscodecontainer">
                                <input className="inputsinsms" maxlength="1" type="text" name="ssn-2" onChange={handleChange} />
                            </div>
                        </Col>
                        <Col span={4} offset={1}>
                            <div className="smscodecontainer">
                                <input className="inputsinsms" maxlength="1" type="text" name="ssn-3" onChange={handleChange} />
                            </div>
                        </Col>
                        <Col span={4} offset={1}>
                            <div className="smscodecontainer">
                                <input className="inputsinsms" maxlength="1" type="text" name="ssn-4" onChange={handleChange} />
                            </div>
                        </Col>
                    </Row>
                    <Row>
